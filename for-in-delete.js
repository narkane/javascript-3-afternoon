...
function secrets(obj) {
  var mtString = "";
  for (id in obj) {
    if (id.startsWith("sh")) mtString += obj[id];
  }
  return mtString;
}
/* 
...
//Code Here
for (id in deleteTheBigNumbers) {
  if (deleteTheBigNumbers[id] > 100) delete deleteTheBigNumbers[id];
}
////////// PROBLEM 7 //////////
...
function hiddenTreasure(obj) {
  for (prop in obj) {
    if (!prop.includes("treasure")) delete obj[prop];
  }
  return obj;
}
